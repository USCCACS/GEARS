...
extern "C" {
#endif
#define LAMMPS_API __declspec(dllexport)
  
void lammps_open(int, char **, MPI_Comm, void **);
void LAMMPS_API lammps_open_no_mpi(int, char **, void **);
void LAMMPS_API lammps_close(void *);
int  lammps_version(void *);
void lammps_file(void *, char *);
char* LAMMPS_API lammps_command(void *, char *);
void lammps_commands_list(void *, int, char **);
void lammps_commands_string(void *, char *);
void lammps_free(void *);

int lammps_extract_setting(void *, char *);
void* LAMMPS_API lammps_extract_global(void *, char *);
void lammps_extract_box(void *, double *, double *, 
                        double *, double *, double *, int *, int *);
void* LAMMPS_API lammps_extract_atom(void *, char *);
